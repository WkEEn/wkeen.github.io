...
<div style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; background: #fafafa;">
  <div style="display: flex; align-items: start; gap: 20px;">
    <div style="flex: 1;">
      <h3 style="margin-top: 0; margin-bottom: 5px;">
        <a href="https://github.com/WkEEn/ExtractPatchFeatures" style="color: #0066cc; text-decoration: none;">Extract Patch Features</a>
      </h3>
      <p style="margin: 0 0 10px 0; font-size: 14px; color: #666;">
        <strong>Foundation Model Feature Extraction for WSI</strong>
      </p>
      <p style="margin: 10px 0; font-size: 14px; line-height: 1.6;">
        Unified toolkit for extracting patch-level features from whole-slide images using state-of-the-art foundation models (GigaPath, UNI, CONCH). Supports parallel processing and various output formats.
      </p>
      <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-top: 10px;">
        <span style="background: #e3f2fd; color: #1976d2; padding: 4px 8px; border-radius: 3px; font-size: 12px;">Feature Extraction</span>
        <span style="background: #f3e5f5; color: #7b1fa2; padding: 4px 8px; border-radius: 3px; font-size: 12px;">Foundation Models</span>
        <span style="background: #e8f5e9; color: #388e3c; padding: 4px 8px; border-radius: 3px; font-size: 12px;">Batch Processing</span>
      </div>
      <div style="display: flex; gap: 10px; margin-top: 12px; font-size: 13px;">
        <a href="https://github.com/WkEEn/ExtractPatchFeatures" style="color: #0066cc; text-decoration: none;">📌 GitHub</a>
      </div>
    </div>
  </div>
</div>

<!-- Data Processing for WSI -->
<div style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; background: #fafafa;">
  <div style="display: flex; align-items: start; gap: 20px;">
    <div style="flex: 1;">
      <h3 style="margin-top: 0; margin-bottom: 5px;">
        <a href="https://github.com/WkEEn/WSIDataProcessing" style="color: #0066cc; text-decoration: none;">WSI Data Processing</a>
      </h3>
      <p style="margin: 0 0 10px 0; font-size: 14px; color: #666;">
        <strong>Graph Construction and Multi-modal Data Synchronization</strong>
      </p>
      <p style="margin: 10px 0; font-size: 14px; line-height: 1.6;">
        Tools for constructing graph representations from WSI and genomics data. Includes RNA-WSI graph construction, spatial graph learning, and multi-modal alignment pipelines.
      </p>
      <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-top: 10px;">
        <span style="background: #e0f2f1; color: #00695c; padding: 4px 8px; border-radius: 3px; font-size: 12px;">Graph Construction</span>
        <span style="background: #f1f8e9; color: #558b2f; padding: 4px 8px; border-radius: 3px; font-size: 12px;">Data Alignment</span>
        <span style="background: #fce4ec; color: #c2185b; padding: 4px 8px; border-radius: 3px; font-size: 12px;">Multi-modal</span>
      </div>
      <div style="display: flex; gap: 10px; margin-top: 12px; font-size: 13px;">
        <a href="https://github.com/WkEEn/WSIDataProcessing" style="color: #0066cc; text-decoration: none;">📌 GitHub</a>
      </div>
    </div>
  </div>
</div>
